...
void cmd_dir(char **, struct DirParams *params);
void show_file_info(const char *, struct DirParams *params);
void list_directory(const char *, struct DirParams *params);
void print_short_format(const char *, struct stat *);
void print_long_format(const char *, struct stat *, struct DirParams *params);
void list_directory_recursive(const char *, struct DirParams *params);
