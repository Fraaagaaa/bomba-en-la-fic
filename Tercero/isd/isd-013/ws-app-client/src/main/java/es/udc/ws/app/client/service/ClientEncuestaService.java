...
public interface ClientEncuestaService
{
    ...
    /* 4 */ public ClientRespuestaDto responderEncuesta(long encuestaId, String email, boolean voto) throws InstanceNotFoundException, InputValidationException, ClientEncuestaExpirationException, ClientEncuestaExpirationException;
