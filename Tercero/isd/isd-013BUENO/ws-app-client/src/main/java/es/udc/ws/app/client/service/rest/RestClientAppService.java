...
public class RestClientAppService implements ClientEncuestaService
{
    ...
    @Override
    public ClientRespuestaDto responderEncuesta(long encuestaId, String email, boolean voto) throws InstanceNotFoundException, InputValidationException
    {
        try
        {
        ...
        catch (InstanceNotFoundException | InputValidationException | ClientEncuestaCanceladaException e)
        {
            throw e;
        }
        catch (Exception e)
    ...
    @Override
    public List<ClientRespuestaDto> buscarRespuestasEncuesta(long encuestaId, boolean soloPositivas)
        throws InstanceNotFoundException, InputValidationException {

        try
        {
            ClassicHttpResponse response = (ClassicHttpResponse) Request.get(getEndpointAddress() + "respuestas?encuestaId=" + encuestaId).execute().returnResponse();
