...
public class Encuesta
{
    ...
    public Encuesta(String pregunta, LocalDateTime fechaFin) {
        ...
        this.fechaFin = fechaFin.withNano(0);
        this.repuestasPositivas = 0;
    ...
    public Encuesta(long id, String pregunta, LocalDateTime fechaCreacion, LocalDateTime fechaFin, boolean cancelada, int repuestasPositivas, int respuestasNegativas) {
        this.id = id;
        this.pregunta = pregunta;
        this.fechaCreacion = fechaCreacion.withNano(0);
        this.fechaFin = fechaFin.withNano(0);
    ...
    public LocalDateTime getFechaCreacion() {
        return fechaCreacion.withNano(0);
    }
