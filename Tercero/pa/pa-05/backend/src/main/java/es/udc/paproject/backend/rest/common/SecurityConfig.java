	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		http.cors(Customizer.withDefaults())
				...
				.authorizeHttpRequests((authorize) -> authorize
						...
						.requestMatchers(HttpMethod.GET, "/catalog/movies/**", "/catalog/sessions/**").permitAll()
						...
						.requestMatchers(HttpMethod.POST, "/shopping/purchases/*/deliver").hasRole("TICKETSELLER") // <-- AÑADIDO: Permiso para entregar entradas
						.anyRequest().denyAll());
