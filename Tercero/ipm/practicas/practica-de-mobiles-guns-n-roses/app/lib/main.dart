  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        Provider<FriendRepository>(create: (context) => FriendRepository(SplitWithMeAPIService())),
        Provider<ExpenseRepository>(create: (context) => ExpenseRepository(SplitWithMeAPIService())),
      ],
