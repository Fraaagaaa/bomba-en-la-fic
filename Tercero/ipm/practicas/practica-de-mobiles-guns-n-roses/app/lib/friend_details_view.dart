...
class _FriendDetailsViewState extends State<FriendDetailsView> {
  ...
  void _loadExpenses() {
    _expensesFuture = Provider.of<ExpenseRepository>(context, listen: false)
        .getExpensesOwedByFriend(_friend);
  }
                ...
                builder: (context, snapshot) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final amountPerParticipant = expense.participantsList.isNotEmpty 
                          ? expense.amount / expense.participantsList.length 
                          : 0.0;
                      ...
                      return ListTile(
                        ...
                        trailing: Text(
                          '${amountPerParticipant.toStringAsFixed(2)}${l10n.currencySymbol}',
