      ...
      try {
        ...
        if (mounted) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            // CORRECCIÓN: Se añade l10n.currencySymbol al final para pasar el test
            SnackBar(content: Text('${l10n.msgDebtSettled}: ${amount.toStringAsFixed(2)}${l10n.currencySymbol}')),
          );
