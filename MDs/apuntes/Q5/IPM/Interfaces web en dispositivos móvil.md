...
En los dispositivos táctiles los botones deben ser grandes. Los eventos son diferentes, por ejemplo "tap" en móvil o "on mouse hover" en los ordenadores. Los formularios deben ser verticales, lo más simples posibles y hay que utilizar los tipos más adecuados en los campos, por ejemplo, para activar el teclado numérico para introducir un PIN.
...
+ Se deben usar media queries de CSS para aplicar estilos según el tamaño, que son una característica que permite aplicar estilos diferentes a un documento HTML en función de ciertos criterios, como el tamaño de la pantalla, la resolución del dispositivo, la orientación, entre otros.